...
export const WEBSITE_REFERENCES = [
  ...
  // --- Portfolio ---
  {
    ...
    category: 'Portfolio',
    screenshot: screenshotFor('https://dribbble.com/'),
    palette: ['#ea4c89', '#ffffff', '#f8f8f8', '#0d0d0d'],
    fonts: { heading: 'Poppins', body: 'Inter', classification: 'geometric-sans' },
    typographyNotes: 'Warm pink accent on clean white, geometric sans throughout.',
    styleTags: ['portfolio', 'pink', 'creative', 'showcase'],
    matchNotes: ['warm pink on white', 'creative showcase platform', 'friendly geometric type'],
  },
  {
    id: 'behance',
    name: 'Behance',
    ...
    category: 'Portfolio',
    screenshot: screenshotFor('https://www.behance.net/'),
    palette: ['#1769ff', '#ffffff', '#f8f8f8', '#1a1a1a'],
    fonts: { heading: 'Inter', body: 'Inter', classification: 'geometric-sans' },
    typographyNotes: 'Vivid Adobe blue on white with clean gallery grid and geometric sans.',
    styleTags: ['portfolio', 'blue', 'clean', 'gallery'],
    matchNotes: ['vivid blue on white', 'gallery-style layout', 'creative portfolio grid'],
  },
  {
    id: 'cargo',
    name: 'Cargo',
    ...
    category: 'Portfolio',
    screenshot: screenshotFor('https://cargo.site/'),
    palette: ['#0d0d0d', '#f5f5f5', '#ffffff', '#888888'],
    fonts: { heading: 'Montserrat', body: 'Inter', classification: 'geometric-sans' },
    typographyNotes: 'Editorial near-black with off-white type, typographic layout.',
    styleTags: ['dark', 'editorial', 'portfolio', 'minimal'],
    matchNotes: ['dark editorial with clean sans', 'typographic layout', 'near-black on white'],
  },
  ...
  // --- Ecommerce ---
  {
    ...
    category: 'Ecommerce',
    screenshot: screenshotFor('https://www.awaytravel.com/'),
    palette: ['#000000', '#ffffff', '#f4ede3', '#8c8279'],
    fonts: { heading: 'Montserrat', body: 'Lato', classification: 'geometric-sans' },
    typographyNotes: 'Stark monochrome with warm sand tones, clean geometric sans.',
    styleTags: ['minimal', 'monochrome', 'premium', 'travel'],
    matchNotes: ['stark black on white', 'warm sand accents', 'premium minimal ecommerce'],
  },
  {
    id: 'patagonia',
    name: 'Patagonia',
    ...
    category: 'Ecommerce',
    screenshot: screenshotFor('https://www.patagonia.com/'),
    palette: ['#1e3a2f', '#ffffff', '#f4f0ea', '#c58c11'],
    fonts: { heading: 'Playfair Display', body: 'Lato', classification: 'display-serif' },
    typographyNotes: 'Deep forest green with warm off-white and amber — editorial serif headings.',
    styleTags: ['outdoor', 'earth tones', 'dark green', 'serif'],
    matchNotes: ['deep green on off-white', 'nature earth palette', 'editorial outdoor serif'],
  },
  {
    id: 'warby-parker',
    name: 'Warby Parker',
    ...
    category: 'Ecommerce',
    screenshot: screenshotFor('https://www.warbyparker.com/'),
    palette: ['#234fa8', '#ffffff', '#e8f0fc', '#111111'],
    fonts: { heading: 'Lato', body: 'Lato', classification: 'humanist-sans' },
    typographyNotes: 'Classic navy on white with friendly humanist sans throughout.',
    styleTags: ['navy', 'clean', 'friendly', 'retail'],
    matchNotes: ['navy blue on white', 'clean product layout', 'friendly humanist sans'],
  },
  ...
  // --- Agency ---
  {
    ...
    category: 'Agency',
    screenshot: screenshotFor('https://www.hugeinc.com/'),
    palette: ['#000000', '#ff2a00', '#ffffff', '#1a1a1a'],
    fonts: { heading: 'Work Sans', body: 'Work Sans', classification: 'humanist-sans' },
    typographyNotes: 'Pure black canvas with electric red accent — bold maximum contrast.',
    styleTags: ['dark', 'agency', 'bold', 'red accent'],
    matchNotes: ['pure black with electric red', 'bold agency aesthetic', 'maximum contrast'],
  },
  {
    id: 'fantasy',
    name: 'Fantasy',
    ...
    category: 'Agency',
    screenshot: screenshotFor('https://fantasy.co/'),
    palette: ['#0a0a0a', '#f5f0e8', '#c49a6c', '#2a2a2a'],
    fonts: { heading: 'Montserrat', body: 'Lato', classification: 'geometric-sans' },
    typographyNotes: 'Near-black with warm gold and off-white — premium dark studio.',
    styleTags: ['dark', 'premium', 'gold', 'studio'],
    matchNotes: ['near-black with gold accent', 'luxury dark studio', 'premium warm dark'],
  },
  {
    id: 'awwwards',
    name: 'Awwwards',
    ...
    category: 'Agency',
    screenshot: screenshotFor('https://www.awwwards.com/'),
    palette: ['#111111', '#f4e04d', '#ffffff', '#f0f0f0'],
    fonts: { heading: 'Montserrat', body: 'Inter', classification: 'geometric-sans' },
    typographyNotes: 'Near-black with bold yellow accent — high contrast design awards aesthetic.',
    styleTags: ['dark', 'yellow', 'awards', 'bold'],
    matchNotes: ['dark with vivid yellow', 'design awards showcase', 'bold high contrast'],
  },
]
